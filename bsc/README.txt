...
==============
  ...
  netnsh:
    ...
    NOTES:
    1. This configuration will work only on the version the bsc
    ...
    2. There is no PHY on the base bsc stm32f107 board.  You must
  ...
  highpri:
    ...
    This configuration targets the bsc board with the STM32F103VCT6
    mounted.
